 ...
 * 喂猪的规则如下：
 * <p>
 * <br>1. 选择若干活猪进行喂养 可以允许小猪同时饮用任意数量的桶中的水，并且该过程不需要时间。
 * <br>2. 小猪喝完水后，必须有 minutesToDie 分钟的冷却时间。在这段时间里，你只能观察，而不允许继续喂猪。
 * <br>3. 过了 minutesToDie 分钟后，所有喝到毒药的猪都会死去，其他所有猪都会活下来。
 * <br>4. 重复这一过程，直到时间用完。
 * <p>
 ...
 * @author Ghost_Yao
 * @version 1.0.0$
 * @date created in 2021/11/25 18:23
 */
public class PoorPigs {
  ...
  public static void main(String[] args) {
    ...
    //answer: 2
    System.out.println(solution.poorPigs(4, 15, 30));
  }
